...
public class Gui extends JFrame {
     ...
     * 
     * @param people
     *            String - records of people (from Main)
     */
    public void display(String people) {
        JOptionPane.showMessageDialog(this, people, 
    ...
    /**
     * Reads in a Person's data (name/phone) using two dialog boxes and returns
     * the Person's data.
     * 
